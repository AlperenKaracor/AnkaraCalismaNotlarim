...
public class Operators {
    ...
    public static void main(String[] args) {
        ...
        /*
        1) +,-,*,/ islemleri javada matematikde kullanildigi gibi kullanilir
        Note 1 : java da bir tamsayiyi baska bir tamsayiya bolerseniz sonuc her zaman tam sayi cikar
        ...
        */
        ...
        AND islemi perfectionist dir bir tane bile false sonucu false yapar
        ...
        4) Comparison (Karsilatirma) Operators
        < , > , <= , >=, == , !=


        NOTE: Karsilastirma operatorleini kullandiginizda sonuc kesinlikle boolean (true , false) alirsiniz
         */
